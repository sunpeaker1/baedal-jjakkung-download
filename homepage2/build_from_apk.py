...
.homepage2DownloadFloat{position:fixed;right:max(12px,calc((100vw - 430px)/2 + 12px));bottom:calc(var(--navh) + 10px);z-index:40;min-width:132px;height:43px;padding:0 15px;border:1px solid rgba(255,255,255,.78);border-radius:999px;background:linear-gradient(145deg,#188ff0,#0a6fd4);color:#fff;text-decoration:none;display:flex;align-items:center;justify-content:center;gap:6px;font-size:12px;font-weight:1000;letter-spacing:-.3px;box-shadow:0 10px 24px rgba(9,108,195,.34),inset 0 1px 0 rgba(255,255,255,.35);backdrop-filter:blur(8px)}
