...
.demoFeedback{width:100%;margin-top:18px;border:1px solid #f2b173;border-radius:16px;padding:15px;background:#fff0df;color:#9a4d10;font-size:17px;font-weight:950;text-decoration:none;display:flex;align-items:center;justify-content:center}
.demoClose{width:100%;margin-top:10px;border:0;border-radius:16px;padding:15px;background:#118cf3;color:#fff;font-size:17px;font-weight:950}
